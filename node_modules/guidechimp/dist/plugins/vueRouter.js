...
(function webpackUniversalModuleDefinition(root, factory) {
	if(typeof exports === 'object' && typeof module === 'object')
		...
		exports["guideChimpPluginVueRouter"] = factory();
	else
		root["guideChimpPluginVueRouter"] = factory();
})(self, function() {
...
module.exports = function (cls, factory, router) {
  ...
  cls.prototype.init = function () {
    ...
    this.on('onBeforeChange', /*#__PURE__*/function () {
      var _ref = (0, _asyncToGenerator2.default)( /*#__PURE__*/_regenerator.default.mark(function _callee(to) {
        var route;
        return _regenerator.default.wrap(function _callee$(_context) {
          while (1) {
            switch (_context.prev = _context.next) {
              case 0:
                route = to.route; // wait for page change
                if (!route) {
                  _context.next = 4;
                  break;
                }
